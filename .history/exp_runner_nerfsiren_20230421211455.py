...
from models.NeRF import NerfMLP,NerfSiren
...
class Runner:
    def __init__(self,dataset,  conf_path, mode='train', case='CASE_NAME', is_continue=False, is_paint = False, iswoab = False):
        ...
        self.sdf_network = NerfSiren(**self.conf['model.sdf_network']).to(self.device)
        ...
        # os.makedirs(self.base_exp_dir, exist_ok=True)
        self.base_exp_dir = self.base_exp_dir + "_siren"
