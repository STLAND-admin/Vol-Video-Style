...
class Video():
    ...
    def gen_rays_at(self, index, resolution_level=1):
        ...
        cameras_pytorch3d = pytorch3d.utils.cameras_from_opencv_projection(R[None], T[None], K[None], self.image_size[None])
        ...
        return rays_o.float(), rays_v.float(), mesh_renderer
