...
class Runner:
    def __init__(self,hyper,  conf_path, mode='train', case='CASE_NAME', is_continue=False, is_paint = False, iswoab = False):
        ...
        if hyper == False:
            ...
            self.dataset = iPhoneDatasetFromAllFrames(self.conf['dataset'])
        ...
        if is_paint ==True:
            ...
            if hyper == False:
                ...
                self.dataset_val = iPhoneDatasetFromAllFrames(self.conf['dataset'], split = 'val')
        else:
            if hyper == False:
                self.dataset_val = Dataset(self.conf['dataset'])
            else:
        ...
        if hyper == False:
            ...
            self.dataset_nv = iPhoneDatasetFromAllFrames(self.conf['dataset'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyper', default=False, action="store_true")
    ...
    runner = Runner(args.hyper, args.conf, args.mode, args.case, args.is_continue, args.paint, args.woab)
