...
class TensorVMSplit(TensorBase):
    ...
    def get_Density_optparam_groups(self, lr_init_spatialxyz = 0.02, lr_init_network = 0.001):
        if self.fix_density:
            grad_vars = [ {'params': self.app_plane, 'lr': lr_init_spatialxyz}]#,
                        # {'params': self.basis_mat.parameters(), 'lr':lr_init_network}]
        else:
            grad_vars = [{'params': self.density_line, 'lr': lr_init_spatialxyz}, {'params': self.density_plane, 'lr': lr_init_spatialxyz},
                        {'params': self.app_line, 'lr': lr_init_spatialxyz}, {'params': self.app_plane, 'lr': lr_init_spatialxyz},
    ...
    def get_RGB_optparam_groups(self, lr_init_spatialxyz = 0.02, lr_init_network = 0.001):
